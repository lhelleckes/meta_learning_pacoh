...
flags.DEFINE_string(
    "exp_name",
    default="meta-overfitting-v2-nps-base-exp",
...
flags.DEFINE_integer(
    "r_dim", default=50, help="dimensionality of the context representation"
)
...
flags.DEFINE_float(
    "lr_decay", default=1.0, help="multiplicative learning rate decay parameter"
)
flags.DEFINE_float(
    "weight_decay",
    default=0.05,
    help="multiplicative weight decay parameter for AdamW optimizer",
)
flags.DEFINE_integer(
    "batch_size",
    5,
...
def main(argv):
    ...
    test_ll_meta_train, test_rmse_meta_train, calib_err_meta_train = npr.eval_datasets(
        meta_train_data, flatten_y=False
    )
    test_ll_meta_test, test_rmse_meta_test, calib_err_test = npr.eval_datasets(
        meta_test_data, flatten_y=False
    )
